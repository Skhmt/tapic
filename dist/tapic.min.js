...
m),h.on("close",g),h.on("error",e)):(h=new WebSocket("wss://pubsub-edge.twitch.tv"),h.onopen=f,h.onmessage=m,h.onclose=g,h.onerror=e)}function f(){var b={type:"LISTEN",nonce:"listenToTopics",data:{topics:["channel-bits-events-v1."+a.channel_id,"chat_moderator_actions."+a.id+"."+a.channel_id,"whispers."+a.id],auth_token:a.oauth}};try{h.send(JSON.stringify(b))}catch(r){setTimeout(function(){h.send(JSON.stringify(b))},1E3)}k()}function g(){b()}function e(a){console.error("pubsub error");console.log(a)}
function k(){try{h.send('{"type":"PING"}')}catch(q){setTimeout(function(){h.send('{"type":"PING"}')},2E3)}setTimeout(k,6E4);p=setTimeout(function(){b()},1E4)}function m(a){a=c(2)?JSON.parse(a):JSON.parse(a.data);switch(a.type){case "PONG":clearTimeout(p);break;case "RESPONSE":break;case "RECONNECT":b();break;case "MESSAGE":n(a.data);break;default:console.log("Uncaught message type received in pubsub."),console.log(a)}}function n(b){function c(){var a=JSON.parse(b.message);d("bits",a)}function f(){var a=
JSON.parse(b.message).data;d("moderation",a)}switch(b.topic){case "channel-bits-events-v1."+a.channel_id:c();break;case "chat_moderator_actions."+a.id+"."+a.id:f();break;case "whispers."+a.id:JSON.parse(b.message)}}var h,p="";b()}},function(d,e){d.exports=function(c,a,d,b,f,e){c.joinChannel=function(c,g){if("string"!=typeof c)return console.error("Invalid parameters. Usage: TAPIC.joinChannel(channel);");if(!d)return console.error("Tapic not setup.");a.channel&&d.send("PART #"+a.channel);e("https://api.twitch.tv/kraken/users",
"\x26login\x3d"+encodeURIComponent(c),function(e){a.channel_id=e.users[0]._id;a.channel=c.replace("#","");a.online=!1;a.game="";a.status="";a.followerCount="";a.totalViewCount="";a.partner="";a.currentViewCount="";a.fps="";a.videoHeight="";a.delay="";a.subBadgeUrl="";a.chatters={};a.followers=[];a.createdAt="";a.logo="";a.videoBanner="";a.profileBanner="";a.userMod="";a.userSub="";a.userTurbo="";a.userType="";d.send("JOIN #"+a.channel);b();"function"==typeof g?f(g):f()})}}},function(d,e){d.exports=
function(c,a,d,b){c.sendChat=function(c){if("string"!=typeof c)console.error("Invalid parameters. Usage: TAPIC.sendChat(message);");else{if(!d)return console.error("Tapic not setup.");d.send("PRIVMSG #"+a.channel+" :"+c);b("echoChat",c)}}}},function(d,e){d.exports=function(c,a,d){c.sendWhisper=function(b,c){if("string"!=typeof b||"string"!=typeof c)console.error("Invalid parameters. Usage: TAPIC.sendWhisper(user, message);");else{if(!a)return console.error("Tapic not setup.");a.send("PRIVMSG #jtv :/w "+
...
var b="/kraken/channels/"+d.channel_id+"/commercial?oauth_token\x3d"+d.oauth,e="https://api.twitch.tv"+b;c(2)?(e={host:"https://api.twitch.tv",path:b,method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded; charset\x3dUTF-8","Client-ID":d.clientid}},c(6).request(e).write({duration:a}).end()):(b=new XMLHttpRequest,b.open("POST",e,!0),b.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset\x3dUTF-8"),b.setRequestHeader("Client-ID",d.clientid),b.send({duration:a}))}}}},
...
function(c,b,d){if("string"===typeof c&&"string"===typeof b&&"function"===typeof d)a("https://api.twitch.tv/kraken/"+c,b,function(a){d(a)});else if("string"===typeof c&&"function"===typeof b)a("https://api.twitch.tv/kraken/"+c,function(a){b(a)});else return console.error("Invalid parameters. Usage: TAPIC.kraken(path, [params,] callback);")}}},function(d,e){}]);