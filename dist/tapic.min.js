...
5<=c&&(a.refreshRate=c)}}},function(d,e){d.exports=function(c,a){c.kraken=function(c,b,d){if("string"===typeof c&&"string"===typeof b&&"function"===typeof d)a("https://api.twitch.tv/kraken/"+c,b,function(a){d(a)});else if("string"===typeof c&&"function"===typeof b)a("https://api.twitch.tv/kraken/"+c,function(a){b(a)});else return console.error("Invalid parameters. Usage: TAPIC.kraken(path, [params,] callback);")}}},function(d,e){}]);